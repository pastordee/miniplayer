...
///Miniplayer class
class MiniplayerAudio extends StatefulWidget {
  ///Required option to set the minimum and maximum height
  final double minHeight, maxHeight, width;
  ...
  @override
  _MiniplayerAudioState createState() => _MiniplayerAudioState();
}

class _MiniplayerAudioState extends State<MiniplayerAudio> with TickerProviderStateMixin {
  late ValueNotifier<double> heightNotifier;
  ValueNotifier<double> dragDownPercentage = ValueNotifier(0);
...
///Miniplayer class
class MiniplayerLink extends StatefulWidget {
  ///Required option to set the minimum and maximum height
  final double minHeight, maxHeight, width;
  ...
  @override
  _MiniplayerLinkState createState() => _MiniplayerLinkState();
}

class _MiniplayerLinkState extends State<MiniplayerLink> with TickerProviderStateMixin {
  late ValueNotifier<double> heightNotifier;
  ValueNotifier<double> dragDownPercentage = ValueNotifier(0);
...
class MiniplayerVideo extends StatefulWidget {
  ...
  @override
  _MiniplayerVideoState createState() => _MiniplayerVideoState();
}

class _MiniplayerVideoState extends State<MiniplayerVideo> with TickerProviderStateMixin {
  late ValueNotifier<double> heightNotifier;
  ValueNotifier<double> dragDownPercentage = ValueNotifier(0);
